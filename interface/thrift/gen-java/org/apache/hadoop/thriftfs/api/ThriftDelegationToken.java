...
public class ThriftDelegationToken implements TBase<ThriftDelegationToken, ThriftDelegationToken._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("ThriftDelegationToken");
  ...
  static {
    ...
    tmpMap.put(_Fields.DELEGATION_TOKEN_BYTES, new FieldMetaData("delegationTokenBytes", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.STRING)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    FieldMetaData.addStructMetaDataMap(ThriftDelegationToken.class, metaDataMap);
  }
  ...
  public ThriftDelegationToken(ThriftDelegationToken other) {
    if (other.isSetDelegationTokenBytes()) {
      this.delegationTokenBytes = TBaseHelper.copyBinary(other.delegationTokenBytes);
;
    }
  }
  ...
  public byte[] getDelegationTokenBytes() {
    setDelegationTokenBytes(TBaseHelper.rightSize(delegationTokenBytes));
    return delegationTokenBytes.array();
  }
  ...
  public ThriftDelegationToken setDelegationTokenBytes(byte[] delegationTokenBytes) {
    setDelegationTokenBytes(ByteBuffer.wrap(delegationTokenBytes));
    return this;
  }
  ...
  public int compareTo(ThriftDelegationToken other) {
    ...
    if (isSetDelegationTokenBytes()) {
      lastComparison = TBaseHelper.compareTo(this.delegationTokenBytes, typedOther.delegationTokenBytes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (this.delegationTokenBytes == null) {
      ...
      TBaseHelper.toString(this.delegationTokenBytes, sb);
    }
    first = false;
    sb.append(")");
    return sb.toString();
