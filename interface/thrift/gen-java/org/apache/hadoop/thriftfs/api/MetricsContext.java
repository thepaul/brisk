...
public class MetricsContext implements org.apache.thrift.TBase<MetricsContext, MetricsContext._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_isMonitoring = true;
    builder.append(present_isMonitoring);
    if (present_isMonitoring)
      builder.append(isMonitoring);

    boolean present_period = true;
    builder.append(present_period);
    if (present_period)
      builder.append(period);

    boolean present_records = true && (isSetRecords());
    builder.append(present_records);
    if (present_records)
