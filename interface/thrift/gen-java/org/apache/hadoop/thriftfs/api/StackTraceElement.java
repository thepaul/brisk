...
public class StackTraceElement implements org.apache.thrift.TBase<StackTraceElement, StackTraceElement._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_methodName);
    if (present_methodName)
      builder.append(methodName);

    boolean present_isNativeMethod = true;
    builder.append(present_isNativeMethod);
    if (present_isNativeMethod)
      builder.append(isNativeMethod);

    boolean present_stringRepresentation = true && (isSetStringRepresentation());
    builder.append(present_stringRepresentation);
    if (present_stringRepresentation)
