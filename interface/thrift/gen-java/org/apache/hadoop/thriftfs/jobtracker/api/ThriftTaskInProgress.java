...
public class ThriftTaskInProgress implements org.apache.thrift.TBase<ThriftTaskInProgress, ThriftTaskInProgress._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<ThriftTaskAttemptID> tasks;
  /**
   * TaskAttemptID (string) to ThriftTaskStatus map
   */
  public Map<String,ThriftTaskStatus> taskStatuses;
  public Map<String,List<String>> taskDiagnosticData;
  public ThriftGroupList counters;
  public String mostRecentState;
  public List<String> runningAttempts;
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case EXEC_START_TIME:
      return new Long(getExecStartTime());

    case EXEC_FINISH_TIME:
      return new Long(getExecFinishTime());
  ...
  public int hashCode() {
    ...
    boolean present_execStartTime = true;
    builder.append(present_execStartTime);
    if (present_execStartTime)
      builder.append(execStartTime);

    boolean present_execFinishTime = true;
    builder.append(present_execFinishTime);
    if (present_execFinishTime)
      builder.append(execFinishTime);

    boolean present_progress = true;
    builder.append(present_progress);
    if (present_progress)
    ...
    builder.append(present_complete);
    if (present_complete)
    ...
    builder.append(present_taskStatuses);
    if (present_taskStatuses)
      builder.append(taskStatuses);

    boolean present_taskDiagnosticData = true && (isSetTaskDiagnosticData());
    builder.append(present_taskDiagnosticData);
    if (present_taskDiagnosticData)
      builder.append(taskDiagnosticData);
    ...
    boolean present_mostRecentState = true && (isSetMostRecentState());
    builder.append(present_mostRecentState);
    if (present_mostRecentState)
      builder.append(mostRecentState);

    boolean present_runningAttempts = true && (isSetRunningAttempts());
    builder.append(present_runningAttempts);
    if (present_runningAttempts)
      builder.append(runningAttempts);

    boolean present_successfulAttempt = true && (isSetSuccessfulAttempt());
    builder.append(present_successfulAttempt);
    if (present_successfulAttempt)
      builder.append(successfulAttempt);
