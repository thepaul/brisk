...
public class ThriftJobCounterRollups implements org.apache.thrift.TBase<ThriftJobCounterRollups, ThriftJobCounterRollups._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_mapCounters = true && (isSetMapCounters());
    builder.append(present_mapCounters);
    if (present_mapCounters)
      builder.append(mapCounters);

    boolean present_reduceCounters = true && (isSetReduceCounters());
    builder.append(present_reduceCounters);
    if (present_reduceCounters)
      builder.append(reduceCounters);

    boolean present_jobCounters = true && (isSetJobCounters());
    builder.append(present_jobCounters);
    if (present_jobCounters)
      builder.append(jobCounters);
