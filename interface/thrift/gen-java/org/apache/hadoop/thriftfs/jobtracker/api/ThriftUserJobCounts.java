...
public class ThriftUserJobCounts implements org.apache.thrift.TBase<ThriftUserJobCounts, ThriftUserJobCounts._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_nPrep = true;
    builder.append(present_nPrep);
    if (present_nPrep)
      builder.append(nPrep);

    boolean present_nRunning = true;
    builder.append(present_nRunning);
    if (present_nRunning)
      builder.append(nRunning);

    boolean present_nSucceeded = true;
    builder.append(present_nSucceeded);
    if (present_nSucceeded)
      builder.append(nSucceeded);

    boolean present_nFailed = true;
    builder.append(present_nFailed);
    if (present_nFailed)
      builder.append(nFailed);

    boolean present_nKilled = true;
    builder.append(present_nKilled);
    if (present_nKilled)
      builder.append(nKilled);
