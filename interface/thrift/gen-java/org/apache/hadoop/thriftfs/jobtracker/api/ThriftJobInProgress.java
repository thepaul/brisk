...
public class ThriftJobInProgress implements org.apache.thrift.TBase<ThriftJobInProgress, ThriftJobInProgress._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_desiredMaps = true;
    builder.append(present_desiredMaps);
    if (present_desiredMaps)
      builder.append(desiredMaps);

    boolean present_desiredReduces = true;
    builder.append(present_desiredReduces);
    if (present_desiredReduces)
      builder.append(desiredReduces);

    boolean present_finishedMaps = true;
    builder.append(present_finishedMaps);
    if (present_finishedMaps)
      builder.append(finishedMaps);

    boolean present_finishedReduces = true;
    builder.append(present_finishedReduces);
    if (present_finishedReduces)
      builder.append(finishedReduces);
    ...
    boolean present_launchTime = true;
    builder.append(present_launchTime);
    if (present_launchTime)
