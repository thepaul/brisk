...
public class ThriftTaskStatus implements org.apache.thrift.TBase<ThriftTaskStatus, ThriftTaskStatus._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_diagnosticInfo = true && (isSetDiagnosticInfo());
    builder.append(present_diagnosticInfo);
    if (present_diagnosticInfo)
      builder.append(diagnosticInfo);

    boolean present_stateString = true && (isSetStateString());
    builder.append(present_stateString);
    if (present_stateString)
      builder.append(stateString);

    boolean present_taskTracker = true && (isSetTaskTracker());
    builder.append(present_taskTracker);
    if (present_taskTracker)
      builder.append(taskTracker);
    ...
    builder.append(present_finishTime);
    if (present_finishTime)
      builder.append(finishTime);

    boolean present_outputSize = true;
    builder.append(present_outputSize);
    if (present_outputSize)
      builder.append(outputSize);

    boolean present_phase = true && (isSetPhase());
    builder.append(present_phase);
    if (present_phase)
      builder.append(phase.getValue());
    ...
    boolean present_shuffleFinishTime = true;
    builder.append(present_shuffleFinishTime);
    if (present_shuffleFinishTime)
      builder.append(shuffleFinishTime);

    boolean present_sortFinishTime = true;
    builder.append(present_sortFinishTime);
    if (present_sortFinishTime)
      builder.append(sortFinishTime);

    boolean present_mapFinishTime = true;
    builder.append(present_mapFinishTime);
    if (present_mapFinishTime)
      builder.append(mapFinishTime);
