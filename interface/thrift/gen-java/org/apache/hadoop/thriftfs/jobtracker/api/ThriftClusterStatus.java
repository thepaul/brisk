...
public class ThriftClusterStatus implements org.apache.thrift.TBase<ThriftClusterStatus, ThriftClusterStatus._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_numActiveTrackers = true;
    builder.append(present_numActiveTrackers);
    if (present_numActiveTrackers)
      builder.append(numActiveTrackers);

    boolean present_activeTrackerNames = true && (isSetActiveTrackerNames());
    builder.append(present_activeTrackerNames);
    if (present_activeTrackerNames)
      builder.append(activeTrackerNames);

    boolean present_blacklistedTrackerNames = true && (isSetBlacklistedTrackerNames());
    builder.append(present_blacklistedTrackerNames);
    if (present_blacklistedTrackerNames)
      builder.append(blacklistedTrackerNames);

    boolean present_numBlacklistedTrackers = true;
    builder.append(present_numBlacklistedTrackers);
    if (present_numBlacklistedTrackers)
      builder.append(numBlacklistedTrackers);

    boolean present_numExcludedNodes = true;
    builder.append(present_numExcludedNodes);
    if (present_numExcludedNodes)
      builder.append(numExcludedNodes);

    boolean present_taskTrackerExpiryInterval = true;
    builder.append(present_taskTrackerExpiryInterval);
    if (present_taskTrackerExpiryInterval)
      builder.append(taskTrackerExpiryInterval);
    ...
    boolean present_usedMemory = true;
    builder.append(present_usedMemory);
    if (present_usedMemory)
    ...
    boolean present_totalSubmissions = true;
    builder.append(present_totalSubmissions);
    if (present_totalSubmissions)
      builder.append(totalSubmissions);

    boolean present_hasRestarted = true;
    builder.append(present_hasRestarted);
    if (present_hasRestarted)
      builder.append(hasRestarted);

    boolean present_hasRecovered = true;
    builder.append(present_hasRecovered);
    if (present_hasRecovered)
      builder.append(hasRecovered);
